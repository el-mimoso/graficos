...
DifusseON m1(Color(0.75, 0.25, 0.25), Color(), 0.5); // pared izq
DifusseON m2(Color(.25, .25, .75), Color(), 0.5);    // pared der
DifusseON m3(Color(.25, .75, .25), Color(), 0.5);    // pared detras
DifusseON m4(Color(.25, .75, .75), Color(), 0.5);    // suelo
DifusseON m5(Color(.75, .75, .25), Color(), 0.5);    // techo
Specular m6(Color(1, 1, 1), Color());                // esfera abajo-izq Espejo
Glass m7(Color(1, 1, 1), Color(), 1.5);              // esfera abajo-der Glass
